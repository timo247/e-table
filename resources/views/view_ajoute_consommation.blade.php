...
<div class="col-sm-offset-3 col-sm-6">
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <form method="POST" action="/consommations/{{$etablissementId}}" enctype="multipart/form-data" role="form">
                @csrf
                ...
                <div class="form-group {!! $errors->has('description') ? 'has-error' : '' !!}">
                    <input class="form-control" placeholder="description" name="description" cols="50" rows="10"
                        type="text"></input>
                    {!! $errors->first('description', '<small class="help-block">:message</small>') !!}
                </div>
                <div class="form-group {!! $errors->has('categorie') ? 'has-error' : '' !!}">
                    <input class="form-control" placeholder="Catégorie" name="categorie" cols="50" rows="10"
                        type="text"></input>
                ...
                <div class="form-group {!! $errors->has('etablissement_id') ? 'has-error' : '' !!}">
                    <input class="form-control" placeholder="Etablissement id"
                        value="{{$etablissementId}}" name="etablissement_id" type="number"></input>
